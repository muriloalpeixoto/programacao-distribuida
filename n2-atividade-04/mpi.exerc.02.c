/*
2 – Fazer um programa em C com MPI que faça os n-processos entrantes enviarem uma mensagem
“Processo X está VIVO!” para o processo inicial 0(ZERO) em ordem de processos.
*/
